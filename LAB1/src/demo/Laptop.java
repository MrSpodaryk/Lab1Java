...
public class Laptop {
    ...
    public Laptop(double speedOfCPU, double capacityOfRAM, String name, double sizeOfDisplay, double price, int number,
            double weight) {
    ...
    public void resetValues(double speedOfCPU, double capacityOfRAM, String name, double sizeOfDisplay, double price,
