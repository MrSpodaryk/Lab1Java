...
Laptop(double speed_of_CPU, double capacity_of_RAM, String name, double size_of_display) {
...
Laptop(double speed_of_CPU, double capacity_of_RAM, String name, double size_of_display, double price) {
	this.speed_of_CPU = speed_of_CPU;
	this.capacity_of_RAM = capacity_of_RAM;
	this.name = name;
	this.size_of_display = size_of_display;
...
public void reset_values(double speed_of_CPU, double capacity_of_RAM, String name, double size_of_display, double price) {
	this.speed_of_CPU = speed_of_CPU;
	this.capacity_of_RAM = capacity_of_RAM;
	this.name = name;
	this.size_of_display = size_of_display;
